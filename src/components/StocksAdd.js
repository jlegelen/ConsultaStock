...
import container from '../containers/StocksAdd'
import '../App.css';
...
class StocksAdd extends React.Component {
    ...
    return (
      <div>
        ...
        <Row>
          ...
          <h1 className="title">Ingreso Productos</h1>
...
export default container(StocksAdd);